...
#   timestamp: 2026-07-21T15:34:51+00:00
...
class MessagesImageSource(BaseModel):
    """
...
class MessagesDocumentSource(BaseModel):
    """
...
class MessagesDocumentBlock(BaseModel):
    """
...
class MessagesToolResultBlock(BaseModel):
    ...
    """
    content: str | Sequence[MessagesTextBlock] | None = None
    """
...
class MessagesRedactedThinkingBlock(BaseModel):
    """
...
class MessagesRequestContentBlock(
    RootModel[
        MessagesTextBlock
        | MessagesImageBlock
...
class MessagesMessage(BaseModel):
    ...
    """
    content: str | Sequence[MessagesRequestContentBlock]
    """
...
class MessagesToolChoice(RootModel[Literal["auto", "any"] | MessagesToolChoice1]):
    root: Literal["auto", "any"] | MessagesToolChoice1
    """
...
class MessagesResponseContentBlock(
    RootModel[
        MessagesTextBlock
        | MessagesToolUseBlock
        | MessagesThinkingBlock
...
class MessagesResponse(BaseModel):
    ...
    Always `assistant`.
    """
    content: Sequence[MessagesResponseContentBlock]
    """
...
class MessagesStreamEvent(BaseModel):
    ...
    """
    content_block: MessagesResponseContentBlock | None = None
    """
